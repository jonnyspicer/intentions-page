...
SECRET_KEY = env(
    "DJANGO_SECRET_KEY",
    default="nSVolS819p40kgtBHDmHIkDki98JfNRi36Ma1LuUS9NqDszRvfVHnJHXtpCbuGrk",
)
...
STATICFILES_FINDERS.append("django.contrib.staticfiles.finders.AppDirectoriesFinder")  # this was originally in base.py
